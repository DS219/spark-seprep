...
PARK_INFO = {
    ...
    "great smoky mountains": {
        ...
        "acadia": {
        "state": "Maine",
        "best_season": "Fall (September-October) for colorful leaves, Summer for hiking and coastline views",
        "top_activities": ["Watch sunrise from Cadillac Mountain", "Drive Park Loop Road",
                           "Hike the Beehive Trail"],
        "things_to_pack": ["Windbreaker", "Hiking shoes", "Camera", "Reusable water bottle"],
        "nearby_airports": ["Bangor, ME (BGR)", "Portland, ME (PWM)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Acadia is one of the first places in the United States to see the sunrise."
    },
    "olympic": {
        "state": "Washington",
        "best_season": "Summer (July-September) for hiking, coast visits, and clearer weather",
        "top_activities": ["Explore Hoh Rain Forest", "Visit Hurricane Ridge",
                           "Walk along Rialto Beach"],
        "things_to_pack": ["Rain jacket", "Waterproof hiking boots", "Warm layers", "Daypack"],
        "nearby_airports": ["Seattle, WA (SEA)", "Port Angeles, WA (CLM)"],
        "campgrounds": ["Kalaloch", "Hoh", "Sol Duc"],
        "fun_fact": "Olympic National Park has mountains, rain forests, and Pacific coastline all in one park."
    }
}
