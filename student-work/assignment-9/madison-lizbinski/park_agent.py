...
PARK_INFO = {
    ...
    "acadia": {
        "state": "Maine",
        "best_season": "Fall (September-October) for foliage, Summer for coastal views",
        "top_activities": ["Drive Park Loop Road", "Watch sunrise on Cadillac Mountain",
                           "Hike Jordan Pond Path"],
        "things_to_pack": ["Light jacket", "Hiking shoes", "Camera", "Rain gear"],
        "nearby_airports": ["Bangor, ME (BGR)", "Bar Harbor, ME (BHB)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Acadia is the first place in the U.S. to see the sunrise for much of the year."
    },
    "rocky mountain": {
        "state": "Colorado",
        "best_season": "Summer (June-September) for hiking, Fall for elk viewing",
        "top_activities": ["Drive Trail Ridge Road", "Hike Bear Lake", "Watch elk in Estes Park"],
        ...
        "fun_fact": "Trail Ridge Road is the highest continuous paved road in the U.S."
    }
}
