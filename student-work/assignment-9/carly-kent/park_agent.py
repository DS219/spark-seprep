...
PARK_INFO = {
    ...
    "acadia": {
	"state": "Maine",
	"best_season": "Mid-September - Mid-October for mild weather, small crowds and foliage, Summer (July-August) for warm weather, Spring for flowers",
	"top_activities": ["Hike Beehive Trail", "Bike carriage roads", "Drive to summit of Cadillac Mountian", "explore scenic Park Loop Road"],
	"things_to_pack": ["Layering clothes", "Rain jacket", "Fleece", "Sunscreen", "Hiking boots", "Bug spray"],
	"nearby_airports": ["Trenton, ME (BHB)", "Bangor, ME (BGR)"], 
	"campgrounds": ["Blackwoods", "Schoodic", "Wild Acadia"],
	"fun_fact": "First national park established east of the Mississippi"
    },
    "arches": {
	"state": "Utah", 
	"best_season": "Spring (April-May) and Fall for mild temperatures and ideal hiking", 
	"top_activities": ["Hike to Delicate Arch", "Explore Windows Section", "View Landscape Arch"], 
	"things_to_pack": ["Water", "Sunscreen", "Wide-brimmed hat", "Hiking boots", "sunglasses", "snacks"], 
	"nearby_airports": ["Grand Country, UT (CNY)", "Salt Lake City, UT (SLC)"], 
	"campgrounds": ["Devils Garden Campground"], 
	"fun_fact": "Worlds highest concentration of natural stone arches"
    } 
}
