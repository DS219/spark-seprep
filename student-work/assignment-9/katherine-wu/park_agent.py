...
PARK_INFO = {
    ...
    "acadia": {
        ...
        "top_activities": ["Drive Park Loop Road", "Hike Cadillac Mountain",
                           "Visit Jordan Pond"],
        "things_to_pack": ["Warm layers for New England weather", "Hiking boots", "Camera for fall colors", "Binoculars for birdwatching"],
        "nearby_airports": ["Hancock County-Bar Harbor Airport (BHB)", "Bangor, ME (BGR)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Cadillac Mountain in Acadia is the first place to see sunrise in the US during certain times of the year."
    },
    "glacier": {
        "state": "Montana",
        "best_season": "Summer (June-August)",
        "top_activities": ["Drive Going-to-the-Sun Road", "Boat tour on Lake McDonald", "Hike the Highline Trail"],
        "things_to_pack": ["Warm layers for mountain weather", "Hiking boots", "Camera for wildlife", "Sunscreen"],
        "nearby_airports": ["Kalispell, MT (FCA)", "Missoula, MT (MSO)"],
        "campgrounds": ["Many Glacier", "St. Mary", "Apgar"],
        "fun_fact": "Glacier National Park has over 130 named lakes and 26 glaciers, though many are rapidly shrinking due to climate change."
    }
}
