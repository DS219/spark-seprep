...
PARK_INFO = {
    ...
    "rocky mountain": {
        "state": "Colorado",
        "best_season": "Summer (July–September) for hiking, Fall for elk rut",
        "top_activities": ["Trail Ridge Road drive", "Hike Emerald Lake", "Spot elk in Moraine Park"],
        "things_to_pack": ["Warm layers", "Rain jacket", "Hiking boots", "Snacks"],
        "nearby_airports": ["Denver, CO (DEN)"],
        "campgrounds": ["Moraine Park", "Glacier Basin", "Aspenglen"],
        "fun_fact": "Rocky Mountain National Park has 77 mountain peaks over 12,000 feet."
    },
    "acadia": {
        "state": "Maine",
        "best_season": "Fall (September–October) for foliage, Summer for coastal hikes",
        "top_activities": ["Hike Cadillac Mountain", "Walk Ocean Path", "Explore Jordan Pond"],
        "things_to_pack": ["Windbreaker", "Comfortable hiking shoes", "Camera", "Water bottle"],
        "nearby_airports": ["Bangor, ME (BGR)", "Bar Harbor, ME (BHB)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Acadia is the first place in the U.S. to see the sunrise for part of the year."
    }
}
