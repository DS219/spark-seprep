...
PARK_INFO = {
    ...
    "rocky mountain": {
        "state": "Colorado",
        "best_season": "Summer (July–August) and Fall",
        "top_activities": ["Hike to Emerald Lake", "Drive Trail Ridge Road", "See elk in Moraine Park"],
        "things_to_pack": ["Warm layers", "Rain jacket", "Hiking boots", "Sunscreen"],
        "nearby_airports": ["Denver, CO (DEN)"],
        "campgrounds": ["Moraine Park", "Glacier Basin", "Aspenglen"],
        "fun_fact": "Rocky Mountain National Park has over 300 miles of hiking trails."
    },
    "acadia": {
        "state": "Maine",
        "best_season": "Summer and early Fall",
        "top_activities": ["Watch sunrise on Cadillac Mountain", "Drive Park Loop Road", "Explore Bar Harbor"],
        "things_to_pack": ["Layers", "Rain jacket", "Camera", "Comfortable walking shoes"],
        "nearby_airports": ["Bangor, ME (BGR)", "Portland, ME (PWM)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Acadia was the first national park east of the Mississippi River."
    },
}
...
# --- FOLLOW-UP QUESTIONS (Enhancement C) ---
