...
PARK_INFO = {
   ...
   "acadia": {
        "state": "Maine",
        "best_season": "Summer (July-August) for hiking, Fall (October) for foliage",
        "top_activities": ["Hike Cadillac Mountain for sunrise", "Cycle the carriage roads",
                           "Explore tide pools at Schoodic Peninsula"],
        "things_to_pack": ["Rain jacket", "Hiking boots", "Warm layers", "Binoculars"],
        "nearby_airports": ["Bangor, ME (BGR)", "Portland, ME (PWM)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Cadillac Mountain in Acadia is the first place to see the sunrise in the US from October to March."
    },
    "olympic": {
        "state": "Washington",
        "best_season": "Summer (July-September) for clear skies and trail access",
        "top_activities": ["Explore the Hoh Rain Forest", "Hike Hurricane Ridge",
                           "Walk the tide pools at Ruby Beach"],
        "things_to_pack": ["Waterproof jacket", "Waterproof boots", "Layers", "Trekking poles"],
        "nearby_airports": ["Seattle, WA (SEA)", "Port Angeles, WA"],
        "campgrounds": ["Hoh", "Kalaloch", "Sol Duc"],
        "fun_fact": "Olympic National Park contains 3 distinct ecosystems: glacier-capped mountains, temperate rainforest, and wild Pacific coastline."
