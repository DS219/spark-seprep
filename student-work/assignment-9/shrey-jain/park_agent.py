...
PARK_INFO = {
    "yellowstone": {
        ...
        "wildlife": ["Grizzly bears", "Gray wolves", "American bison", "Elk", "Bald eagles"]
    },
    "yosemite": {
        "state": "California",
        ...
        "wildlife": ["Black bears", "Mule deer", "Coyotes", "Peregrine falcons", "Steller's jays"]
    },
    "grand canyon": {
        "state": "Arizona",
        ...
        "wildlife": ["California condors", "Mule deer", "Bighorn sheep", "Rattlesnakes", "Ravens"]
    },
    "zion": {
        "state": "Utah",
        "best_season": "Spring (March-May) or Fall (September-November)",
        ...
        "wildlife": ["California condors", "Mule deer", "Rock squirrels", "Canyon tree frogs", "Peregrine falcons"]
    },
    "great smoky mountains": {
        ...
        "wildlife": ["Black bears", "White-tailed deer", "Wild turkeys", "Salamanders", "Fireflies"]
    }
}
...
def plan_trip(park_name):
    ...
    Breaks the work into steps:
      ...
      5. [Option B] Wildlife guide based on the itinerary
...
Travel info: {logistics[:200]}"""
    ...
    # STEP 5: Wildlife guide based on the itinerary
    print("\n[Agent] Step 5: Generating a wildlife guide...\n")

    wildlife_prompt = f"""You are a nature guide for {park_name.title()} National Park.

The traveler's itinerary includes these activities:
{itinerary[:400]}

Known wildlife in the park: {', '.join(park['wildlife'])}

Write a short wildlife guide (3-5 sentences) that tells the traveler:
- Which animals they are most likely to spot given their activities
- The best time of day to see them
- One important safety tip for wildlife encounters"""

    wildlife_guide = ask_llm(wildlife_prompt)
    print("--- Wildlife Guide ---")
    print(wildlife_guide)
