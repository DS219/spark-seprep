...
PARK_INFO = {
    ...
    # Enhancement A: add 2 more parks
    "arches": {
        "state": "Utah",
    ...
    "olympic": {
        ...
        "fun_fact": "Olympic National Park includes mountains, rainforest, and coastline in one park."
    }
}
...
Travel info: {logistics[:200]}"""
    ...
    # Enhancement D: save to file
    filename = f"{park_name.lower().replace(' ', '_')}_trip_plan.txt"
    with open(filename, "w") as f:
        f.write(f"Trip Plan for {park_name.title()}\n")
        f.write("=" * 50 + "\n\n")
        f.write("ITINERARY\n")
        f.write(itinerary + "\n\n")
...
# Enhancement C: follow-up questions
...
Here is the trip summary: {result['summary']}
