...
PARK_INFO = {
    ...
    "olympic": {
        "state": "Washington",
        "best_season": "Summer (July-September) for clear weather and full trail access",
        "top_activities": ["Hike the Hoh Rain Forest", "Explore Rialto Beach tide pools",
                           "Climb Hurricane Ridge for mountain views"],
        "things_to_pack": ["Waterproof rain gear", "Gaiters", "Hiking poles",
        ...
        "fun_fact": "Olympic National Park contains three distinct ecosystems: temperate rainforest, subalpine, and Pacific coastline — all within one park."
    },
    "acadia": {
        "state": "Maine",
        "best_season": "Fall (September-October) for foliage and fewer crowds",
        "top_activities": ["Watch sunrise from Cadillac Mountain", "Cycle the carriage roads",
                           "Hike the Precipice Trail"],
        "things_to_pack": ["Wind-resistant jacket", "Bike helmet", "Sturdy trail shoes", "Binoculars"],
        "nearby_airports": ["Bangor, ME (BGR)", "Portland, ME (PWM)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Cadillac Mountain in Acadia is the first place in the United States to see the sunrise for much of the year."
    }
}
