...
PARK_INFO = {
    ...
    # OPTION A: 2 new parks added
    "olympic": {
        "state": "Washington",
        "best_season": "Summer (July-September)",
        "top_activities": ["Explore Hoh Rain Forest", "Hike Hurricane Ridge", "Tide pooling at Ruby Beach"],
        "things_to_pack": ["Waterproof jacket", "Rain pants", "Hiking boots", "Layers"],
        "nearby_airports": ["Seattle, WA (SEA)", "Port Angeles, WA"],
        "campgrounds": ["Kalaloch", "Hoh", "Sol Duc"],
        "fun_fact": "Olympic National Park contains one of the few temperate rainforests in the US, receiving up to 14 feet of rain per year."
    },
    "acadia": {
        "state": "Maine",
        "best_season": "Fall (September-October) for foliage, Summer for hiking",
        "top_activities": ["Watch sunrise from Cadillac Mountain", "Hike the Beehive Trail", "Cycle the carriage roads"],
        "things_to_pack": ["Warm layers", "Wind jacket", "Hiking shoes", "Binoculars for birdwatching"],
