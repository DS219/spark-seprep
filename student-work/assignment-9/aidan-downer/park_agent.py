...
PARK_INFO = {
    ...
    "acadia": {
        "state": "Maine",
        "best_season": "Summer (June-August) or Fall (September-October)",
        "top_activities": [
        ...
        "fun_fact": "Acadia was the first national park established east of the Mississippi River."
    },
    "rocky mountain": {
        "state": "Colorado",
        "best_season": "Summer (June-September) or Fall for elk season",
        "top_activities": [
