...
Include a fun fact: {park['fun_fact']}"""
    ...
    # STEP 4: Budget estimate  ← Option B
    print("\n[Agent] Step 4: Estimating a simple budget...\n")

    budget_prompt = f"""You are helping plan a budget-friendly 2-day trip to {park_name.title()} National Park.
...
- Planned itinerary: {itinerary[:400]}

Give a simple estimated budget for:
1. Transportation
2. Camping/lodging
3. Food
4. Park-related essentials

Keep it short and realistic. End with an estimated total range in US dollars."""
...
trip_data = plan_trip(park_choice)
...
Itinerary: {trip_data['itinerary'][:300]}
Packing list: {trip_data['packing_list'][:200]}
Travel logistics: {trip_data['logistics'][:200]}
Budget: {trip_data['budget'][:200]}
