...
PARK_INFO = {
	...
	"best_season": "Spring (March-May) or Fall (September-November)",
	"top_activities": ["Hike Skyline Trail", "Visit Narada Falls",
			   "Visit Reflection Lakes", "Hike Grove of the Patriarchs"],
	"things_to_pack": ["Hiking boots", "Rain jacket", "Sunglasses", "Camera"],
	"nearby_airports": ["Seattle-Tacoma International Airport (SEA)", "Yakima Air Terminal (YKM)"],
	"campgrounds": ["Cougar Rock", "White River", "Silver Springs"],
	"fun_fact": "Mount Rainier is visible from anywhere in Washington State."
    },
    "acadia": {
	"state": "Maine",
	"best_season": "Spring (March-May) or Fall (September-November)",
	"top_activities": ["Watch the sunrise on Cadillac Mountain", "Bike the Carriage Roads", "Drive around Park Loop Road"],
	"things_to_pack": ["Hiking boots", "Rain jacket", "Sunglasses", "Camera"],
	"nearby_airports": ["Hancock County-Bar Harbor Airport (BHB) - Trenton, ME", "Bangor International Airport (BGR) - Bangor, ME"],
	"campgrounds": ["Blackwoods", "Schoodic Woods", "Seawall"],
	"fun_fact": "Acadia National Park is the first national park established east of the Mississippi."
    }
}
