...
Travel info: {logistics[:200]}"""
    ...
    filename = park_name.lower().replace(" ", "_") + "_trip_plan.txt"
    with open(filename, "w", encoding="utf-8") as f:
        f.write(f"Trip Plan for {park_name.title()} National Park\n")
        f.write("=" * 50 + "\n\n")
        f.write("ITINERARY\n")
        f.write(itinerary + "\n\n")
