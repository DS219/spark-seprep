...
Include a fun fact: {park['fun_fact']}"""
    ...
    print("\n[Agent] Step 4: Creating Budget Estimate...\n")

    budget_prompt = f"""Estimate a simple budget for a 2-day trip to {park_name.title()} National Park.
Include: - Park entrance fee
- Average cost of camping per night
- Estimated food costs for 2 days
Use the following info:
Park entrance fee: $35 per vehicle (valid for 7 days)
Average camping cost: $20-$30 per night
Food costs: $10-$15 per meal if cooking, $15-$25 per meal if eating out."""
