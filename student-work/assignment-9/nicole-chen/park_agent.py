...
PARK_INFO = {
    ...
    "rocky mountain": {
        ...
        "things_to_pack": ["Warm layers", "Rain jacket", "Hiking boots", "Reusable water bottle"],
        "nearby_airports": ["Denver, CO (DEN)", "Fort Collins/Loveland, CO (FNL)"],
        "campgrounds": ["Moraine Park", "Glacier Basin", "Aspenglen"],
        "fun_fact": "Rocky Mountain National Park has 77 mountain peaks over 12,000 feet high."
    },
    "acadia": {
        "state": "Maine",
        "best_season": "Fall (September-October) or Summer (June-August)",
        "top_activities": ["Watch sunrise from Cadillac Mountain", "Bike the carriage roads",
                           "Hike the Beehive Trail"],
        "things_to_pack": ["Windbreaker", "Daypack", "Trail shoes", "Bug spray"],
        "nearby_airports": ["Bangor, ME (BGR)", "Bar Harbor, ME (BHB)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Acadia National Park protects much of Mount Desert Island along Maine's rugged coast."
    } 
}
