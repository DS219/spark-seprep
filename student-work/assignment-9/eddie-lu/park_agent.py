...
PARK_INFO = {
    ...
    "everglades": {
        "state": "Florida",
        "best_season": "Winter (December-April)",
        "top_activities": ["Airboat tour through the sawgrass marshes", 
                           "Kayaking in Florida Bay", 
                           "Wildlife spotting for alligators and manatees"],
        "things_to_pack": ["Bug spray", "Sunscreen", "Light breathable clothing", 
                           "Water shoes", "Binoculars"],
        "nearby_airports": ["Miami, FL (MIA)", "Fort Lauderdale, FL (FLL)"],
        "campgrounds": ["Long Pine Key", "Flamingo", "Chekika"],
        "fun_fact": "The Everglades is the only place in the world where alligators and crocodiles coexist."
    },
    "rocky mountain": {
        "state": "Colorado",
        "best_season": "Summer (June-August) for hiking, Fall for foliage",
        "top_activities": ["Drive Trail Ridge Road, the highest paved road in the US", 
                           "Hike to Sky Pond", 
                           "Wildlife watching for elk and bighorn sheep"],
        "things_to_pack": ["Warm layers for high altitude", "Sunscreen", 
                           "Rain jacket", "Hiking boots", "Altitude sickness medication"],
        "nearby_airports": ["Denver, CO (DEN)", "Colorado Springs, CO (COS)"],
        "campgrounds": ["Moraine Park", "Glacier Basin", "Aspenglen"],
        "fun_fact": "Rocky Mountain National Park has 77 peaks over 12,000 feet elevation."
    },
}
