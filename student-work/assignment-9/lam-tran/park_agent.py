...
PARK_INFO = {
    ...
    "glacier": {
        ...
        "top_activities": ["Drive Going-to-the-Sun Road", "Hike Highline Trail",
                           "Boat on Lake McDonald"],
        "things_to_pack": ["Bear spray", "Warm layers", "Rain gear", "Binoculars"],
        "nearby_airports": ["Glacier Park International, MT (FCA)", "Missoula, MT (MSO)"],
        "campgrounds": ["Apgar", "Many Glacier", "St. Mary"],
        "fun_fact": "Glacier had 150 glaciers in 1850; fewer than 25 remain today."
    },
    "acadia": {
        "state": "Maine",
        ...
        "top_activities": ["Watch sunrise from Cadillac Mountain", "Bike the carriage roads",
                           "Explore tide pools at Bar Island"],
        "things_to_pack": ["Windbreaker", "Layers for coastal weather", "Sturdy shoes", "Camera"],
        "nearby_airports": ["Bangor, ME (BGR)", "Bar Harbor, ME (BHB)"],
        "campgrounds": ["Blackwoods", "Seawall", "Schoodic Woods"],
        "fun_fact": "Cadillac Mountain is the first place to see sunrise in the US from October to March."
    }
}
